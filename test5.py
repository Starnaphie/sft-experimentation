"""
test5.py -- Qwen3-1.7B trained on augmented_train_v3.json (5 000 examples).

Same architecture as test1.py:qwen3, new augmented data with:
  - SQL-grounded NL variants
  - Hard negative mining
  - Schema-aware oversampling
  - Quality filtering

Adapter  → ./adapter_t5_v3_qwen3/
Preds    → ./preds_t5_v3_qwen3.json
...
BATCH_SIZE    = 2
GRAD_ACCUM    = 2
ADAPTER_DIR   = './adapter_t5_v4_qwen3'
PREDS_FILE    = './preds_t5_v4_qwen3.json'
...
def train():
    print(f"\n{'='*65}")
    print(f"  test5: Qwen3-1.7B + augmented_train_v4 (clean, ~3000 examples)")
